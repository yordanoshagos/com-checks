/*
  ...
  Drop sessions and verification codes before moving to Better Auth's schema
*/
...
/*
  ...
  - You are about to drop the column `lastLoggedIn` on the `Session` table. All the data in the column will be lost.
